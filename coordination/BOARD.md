...
| T-007 | v1.2 backend: transfers/credit-card model, rules+heuristic categorization, freshness, analytics, AI budget | backend-dev agent | ws/spending-be | review — 219 tests (162 baseline preserved), coordinator ruling passes 1+2 applied, ruff clean |
